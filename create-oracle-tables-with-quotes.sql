-- ============================================
-- SCRIPT COMPLETO PARA ORACLE DATABASE COM ASPAS DUPLAS
...
-- Tabela de usuários (com aspas duplas para case-sensitive)
...
-- Tabela de motos (com aspas duplas para case-sensitive)
CREATE TABLE "motos" (
...
-- Tabela de status das motos (com aspas duplas para case-sensitive)
...
-- Tabela de operações (com aspas duplas para case-sensitive)
...
-- Tabela de dashboard (com aspas duplas para case-sensitive)
